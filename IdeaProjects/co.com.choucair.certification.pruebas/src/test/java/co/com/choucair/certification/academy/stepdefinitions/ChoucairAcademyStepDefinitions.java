...
public class ChoucairAcademyStepDefinitions {
    ...
    public void heSearchForTheCourseRecursosAutomnatizacionBancolombiaOnTheChoucairAcademyPlatform(String course) {
        OnStage.theActorInTheSpotlight().attemptsTo(Search.the(course));
    }

    @Then("^he finds the called resources (.*)$")
    public void heFindsTheCalledResourcesRecursosAutomatizacionBancolombia(String question) {
